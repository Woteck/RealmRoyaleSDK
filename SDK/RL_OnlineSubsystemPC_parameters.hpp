...
struct UOnlineSubsystemPC_UnmuteAll_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
	bool                                               ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};
...
struct UOnlineSubsystemPC_MuteAll_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
...
struct UOnlineSubsystemPC_SetSpeechRecognitionObject_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
...
struct UOnlineSubsystemPC_SelectVocabulary_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
...
struct UOnlineSubsystemPC_ClearRecognitionCompleteDelegate_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
...
struct UOnlineSubsystemPC_AddRecognitionCompleteDelegate_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
	struct FScriptDelegate                             RecognitionDelegate;                                      // (Parm, NeedCtorLink)
};
...
struct UOnlineSubsystemPC_OnRecognitionComplete_Params
{
};

// Function OnlineSubsystemPC.OnlineSubsystemPC.GetRecognitionResults
struct UOnlineSubsystemPC_GetRecognitionResults_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
...
struct UOnlineSubsystemPC_StopSpeechRecognition_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
	bool                                               ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};
...
struct UOnlineSubsystemPC_StartSpeechRecognition_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
	bool                                               ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};
...
struct UOnlineSubsystemPC_StopNetworkedVoice_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
};

// Function OnlineSubsystemPC.OnlineSubsystemPC.StartNetworkedVoice
struct UOnlineSubsystemPC_StartNetworkedVoice_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
};

// Function OnlineSubsystemPC.OnlineSubsystemPC.UnmuteRemoteTalker
struct UOnlineSubsystemPC_UnmuteRemoteTalker_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
	struct FUniqueNetId                                PlayerID;                                                 // (Parm)
...
struct UOnlineSubsystemPC_MuteRemoteTalker_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
	struct FUniqueNetId                                PlayerID;                                                 // (Parm)
	bool                                               bIsSystemWide;                                            // (OptionalParm, Parm)
...
struct UOnlineSubsystemPC_SetRemoteTalkerPriority_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
	struct FUniqueNetId                                PlayerID;                                                 // (Parm)
	int                                                Priority;                                                 // (Parm)
...
struct UOnlineSubsystemPC_IsHeadsetPresent_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
	bool                                               ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};
...
struct UOnlineSubsystemPC_IsRemotePlayerTalking_Params
{
	struct FUniqueNetId                                PlayerID;                                                 // (Parm)
	bool                                               ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};
...
struct UOnlineSubsystemPC_IsLocalPlayerTalking_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
	bool                                               ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};
...
struct UOnlineSubsystemPC_UnregisterRemoteTalker_Params
{
	struct FUniqueNetId                                PlayerID;                                                 // (Parm)
	bool                                               ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};
...
struct UOnlineSubsystemPC_RegisterRemoteTalker_Params
{
	struct FUniqueNetId                                PlayerID;                                                 // (Parm)
	bool                                               ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};
...
struct UOnlineSubsystemPC_UnregisterLocalTalker_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
...
struct UOnlineSubsystemPC_RegisterLocalTalker_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
	unsigned char                                      ChannelIndex;                                             // (OptionalParm, Parm)
	bool                                               ReturnValue;                                              // (Parm, OutParm, ReturnParm)
...
struct UOnlineSubsystemPC_ClearPlayerTalkingDelegate_Params
{
...
struct UOnlineSubsystemPC_AddPlayerTalkingDelegate_Params
{
	struct FScriptDelegate                             TalkerDelegate;                                           // (Parm, NeedCtorLink)
};

// Function OnlineSubsystemPC.OnlineSubsystemPC.OnPlayerTalkingStateChange
struct UOnlineSubsystemPC_OnPlayerTalkingStateChange_Params
{
	struct FUniqueNetId                                Player;                                                   // (Parm)
