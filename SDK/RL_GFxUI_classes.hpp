...
public:
	...
	bool ReturnPooledMovie(class UGFxObject* pObj);
	class UGFxObject* AttachPooledMovie(const struct FString& symbolname, const struct FString& instancename, int Depth, unsigned char byTypeId, class UClass* Type);
